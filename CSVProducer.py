...
if len(sys.argv) > 1:
    for i, arg in enumerate(sys.argv):
        if i == 1:
            ...
            CSV_OUTPUT_PATH_1 = "/CSVOutputsValid/" + file_name + "/horse_pose_predictions.csv"
            CSV_OUTPUT_PATH_2 = "/CSVOutputsValid/" + file_name + "/human_pose_predictions.csv"
            CSV_OUTPUT_PATH_3 = "/CSVOutputsValid/" + file_name + "/bounding_pose_predictions.csv"
